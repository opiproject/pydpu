...
_TUNNELSPEC = DESCRIPTOR.message_types_by_name['TunnelSpec']
_DROPNEXTHOP = DESCRIPTOR.message_types_by_name['DropNexthop']
_TUNNELSTATUS = DESCRIPTOR.message_types_by_name['TunnelStatus']
...
TunnelSpec = _reflection.GeneratedProtocolMessageType('TunnelSpec', (_message.Message,), {
  'DESCRIPTOR' : _TUNNELSPEC,
  '__module__' : 'tunnel_pb2'
  # @@protoc_insertion_point(class_scope:opi_api.network.cloud.v1alpha1.TunnelSpec)
  })
_sym_db.RegisterMessage(TunnelSpec)
...
TunnelStatus = _reflection.GeneratedProtocolMessageType('TunnelStatus', (_message.Message,), {
  'DESCRIPTOR' : _TUNNELSTATUS,
  '__module__' : 'tunnel_pb2'
  # @@protoc_insertion_point(class_scope:opi_api.network.cloud.v1alpha1.TunnelStatus)
  })
_sym_db.RegisterMessage(TunnelStatus)
